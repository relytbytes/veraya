    ...
    <svg viewBox="0 0 48 48" fill="none" className={className} role="img" aria-label="Vera">
      <defs>
        ...
        <linearGradient id="veraBlade" x1="12" y1="13" x2="34" y2="35" gradientUnits="userSpaceOnUse">
          <stop offset="0" stopColor="#3CEBD2" />
          <stop offset="1" stopColor="#00A88F" />
        </linearGradient>
      </defs>
      {/* coin + rim */}
      <circle cx="24" cy="24" r="23" fill="url(#veraCoin)" />
      <circle cx="24" cy="24" r="22.4" fill="none" stroke="#2C4D6B" strokeWidth="1" />
      ...
      {/* sparkle */}
      <path d="M35.5 8 L37 12 L41 13.5 L37 15 L35.5 19 L34 15 L30 13.5 L34 12 Z" fill="#FFB703" />
      <circle cx="30.5" cy="20.5" r="1" fill="#FFD66B" />
    </svg>
  );
}
