                    ...
                    >
                      ...
                      <View
                        style={{
                          ...
                          borderRadius: 10,
                          borderWidth: 2,
                          borderColor: item.completedAt ? C.jade : C.rim,
                          backgroundColor: item.completedAt ? C.jade : "transparent",
                          alignItems: "center",
                          justifyContent: "center",
                        }}
                      >
                        {item.completedAt && (
                          <Ionicons name="checkmark" size={12} color={C.void} />
                        )}
                      </View>
                      <Text
                        style={{
                          ...
                          fontSize: 14,
                          fontWeight: "600",
                          color: item.completedAt ? C.smoke : C.pearl,
